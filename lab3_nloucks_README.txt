...
ReadMe for CacheSim 
The File addresses.txt is provided and contains a list of semi-random 64 bit addresses.

Would like to implement using a doubly linked-list but was unable to change it to this
structire in time. 

Full source code can be found at: https://github.com/nrloucks/CSC322_lab3_CacheSim
